<template>
  <Layout>
    ...
    <div class="md:flex leading-loose">
      <div class="md:w-32">
        <h2 class="font-normal mr-12 my-2 text-dark">Music</h2>
      </div>
      <div class="md:max-w-sm">
        ...
        <p>
          ...
          <a href="/albums/heres-a-health-to-the-company">
            "Here`s a Health to
            the Company"
          ...
          <a href="/albums/not-before-time">"Not Before Time"</a> in 2007, in 2018 I released my CD
    ...
    <div class="md:flex mt-8 leading-loose">
      <div class="md:w-32">
        <h2 class="mr-12 my-2 text-dark">Artwork</h2>
      </div>
      <div class="md:max-w-sm">
        <p class="my-6">
        ...
        <p class="my-6">
          ...
          <a href="/art">artwork</a> can be found on this site and is available to purchase.
        </p>
