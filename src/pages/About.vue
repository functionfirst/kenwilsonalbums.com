  ...
  <Layout>
    ...
    <div class="md:flex">
      ...
      <div class="mt-4 md:ml-24">
        <g-image width="400" class="rounded shadow-lg block w-full" src="~/assets/images/about_ken.jpg" alt="Photo of Ken singing" />
      </div>
    </div>
    ...
    <div class="md:flex mt-8">
      ...
      <div class="mt-4 md:ml-24">
        <g-image width="400" class="rounded shadow-lg block w-full" src="~/assets/images/about_ken2.jpg" alt="A self portrait drawing of Ken" />
      </div>
    </div>
  </Layout>
</template>
