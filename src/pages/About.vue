<template>
  <Layout>
    ...
    <div class="md:flex">
      ...
      <div class="leading-normal md:max-w-sm">
        <p class="my-4">
          ...
          <a
            href="http://thewilsonfamilyalbum.co.uk"
            target="_blank"
          >The Wilson Family</a>, frequented folk
        ...
        <p class="my-4">
          ...
          <a
            href="https://www.thelastshipmusical.co.uk/"
            target="_blank"
          >"The Last Ship"</a>
        ...
        <p>
          ...
          <a
            href="/albums/heres-a-health-to-the-company"
          >
            "Here`s a Health to
            the Company"
          </a> with my close friend and collaberator Jim McFarland, whom I had been singing with since
          2013. I have released 2 solo albums, the first being
          <a
            href="/albums/not-before-time"
          >"Not Before Time"</a> in 2007, in 2018 I released my CD
          <a href="/albums/portraits">"Portraits"</a> which has been well received, with great reviews.
        </p>
      </div>
      <div class="mt-4 md:ml-24">
        <g-image
          width="400"
          class="block w-full"
    ...
    <div class="md:flex mt-8">
      ...
      <div class="leading-normal md:max-w-sm">
        <p class="my-2">
          ...
          from work.
          <em>A further operation in 2018 has led to an improvement in my health.</em>
        </p>
        ...
        <p class="my-2">
          ...
          received. Most of my past and future
          <a
            href="/art"
          >artwork</a> can be found on this site and is available to purchase.
        </p>
      ...
      <div class="mt-4 md:ml-24">
        <g-image
          width="400"
          class="block w-full"
          src="~/assets/images/about_ken2.jpg"
          alt="A self portrait drawing of Ken"
        />
      </div>
    </div>
  </Layout>
