...
export default {
  ...
  computed: {
    ...
    paypalUrl() {
      return `https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=${this.business}&item_name=${this.name}&amount=${this.price}&currency_code=${this.currencyCode}&item_number=${this.item.number}&shipping=${this.shipping}`;
    }
  },
  props: {
    item: {
