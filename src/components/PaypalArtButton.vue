<template>
  <div>
    <h2 class="leading-normal font-normal mb-4">Canvas Sizes &amp; Costs</h2>

    <label class="flex items-center cursor-pointer my-2 hover:text-dark">
      <input type="radio" name="poster_type" class="cursor-pointer" />
      <div class="ml-2">
        Poster
    ...
    <table class="border border-dark w-full">
      <thead>
          <tr class="bg-darker text-lighter border border-darker">
              <td class="p-2">Size</td>
              <td class="p-2">Dimensions</td>
              <td class="p-2">Type</td>
              <td class="p-2">Price</td>
          </tr>
      </thead>
      <tbody>
        <tr class="border border-dark bg-base">
          <td class="p-2">A4</td>
          <td class="p-2">12" x 8"</td>
          <td class="p-2">Poster Print</td>
          <td class="p-2">(£15) + P&amp;P </td>
        </tr>
        <tr class="border border-dark">
          <td class="p-2">A3</td>
          <td class="p-2">16" x 12"</td>
          <td class="p-2">Poster Print</td>
          <td class="p-2">£25 + P&amp;P</td>
        </tr>
        <tr class="border border-dark">
          <td class="p-2">A3</td>
          <td class="p-2">16" x 12"</td>
          <td class="p-2">Canvas Print</td>
          <td class="p-2">£50 + P&amp;P</td>
        </tr>
        <tr class="border border-dark">
          <td class="p-2"></td>
          <td class="p-2">30" x 20"</td>
          <td class="p-2">Canvas Print</td>
          <td class="p-2">£85 + P&amp;P</td>
        </tr>
      </tbody>
    </table>
    ...
    <div class="flex flex-col self-start rounded bg-base mt-4 p-4 shadow-inner">
      ...
      <button
        @click="buy()"
        class="paypal w-full mt-4 inline-block rounded py-3 px-6 no-underline"
      >
