<template>
  <header class="lg:flex items-center md:py-2 max-w-2xl mx-auto justify-between w-full">
    <div class="flex justify-between md:justify-center lg:justify-between">
      <g-link
        to="/"
        class="flex flex-col text-center lg:text-left no-underline p-4 block hover:opacity-75"
      >
      ...
      <button
        class="md:hidden flex items-end justify-center flex-col text-lighter p-3"
    ...
    <a
      ...
      rel="noreferrer"
      target="_blank"
      class="py-4 px-6 items-center text-lighter hover:text-dark no-underline"
    >
